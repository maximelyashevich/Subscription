...
public class PageRedirectAdminSecurityFilter implements Filter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (httpRequest.getSession().getAttribute(TextConstant.USER_PARAM)==null || !ClientType.ADMIN.equals(((User)httpRequest.getSession().getAttribute(TextConstant.USER_PARAM)).getType())) {
