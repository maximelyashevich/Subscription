...
<head>
    ...
    <script type="text/javascript">
        ...
        function viewDiv(id, idMain, idClose){
...
<header class="header-login-signup">
    <div class="header-limiter">
        ...
        <ul>
            <li class="tab active"><a href="javascript:void(0);" onclick="viewDiv('formID', 'login', 'signup');">Login</a></li>
            <li class="tab"><a href="javascript:void(0);" onclick="viewDiv('formID', 'signup', 'login');">Sign up</a></li>
        </ul>
    </div>
</header>
...
<div id="signup">
    ...
    <form name="signup" method="POST" action="controller">
        ...
        <p>
            <button class="button-cancel" onclick="closeDiv('formID', 'signup');">CANCEL</button>
        </p>
    </form>
</div>
<div id="login">
...
<div class="field-wrap">
   <label>
    ...
    <p>
    <button class="button-cancel" onclick="closeDiv('formID', 'login');">CANCEL</button>
    </p>
    </form>
    </div>
    </div><!-- tab-content -->
