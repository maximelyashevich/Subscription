...
<head>
    ...
    <script type="text/javascript" src="/resource/js/login-main.js"></script>
</head>
<body>
...
<main style="padding: 50px 0 722px;">
    <ul class="sidebar-menu">
        ...
        <li class="have-children"><a href="#"><span class="fa fa-user"></span>User</a>
            <ul>
                <li><a href="#" onclick="showDivBlock('userTable', 'pagination')">View users</a></li>
